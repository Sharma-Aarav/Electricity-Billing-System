...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter) {
        ...
        try {
            ...
            String query="select * from customerdet where meter_no = '"+meter+"'";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                ...
                String query="update customerdet set address = '"+address+"', city = '"+city+"', state = '"+state+"', email = '"+email+"', phone = '"+phone+"' where meter_no = '"+meter+"'";
